...
namespace DAO
{
    ...
    {
        private static DAO_NhaCC instance;

        public DAO_NhaCC()
        {
        }

        public static DAO_NhaCC Intance
        {
            get { if (instance == null) instance = new DAO_NhaCC(); return instance; }
            set => instance = value;
        }
        ...
        public List<DTO_NhaCungCap> getListNCC()
        {
            ...
            {
                DTO_NhaCungCap hangHoa = new DTO_NhaCungCap(item);
                list.Add(hangHoa);
            }
            return list;
        }
